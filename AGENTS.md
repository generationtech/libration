...
- **Weather/cloud participation (planning shipped, no runtime):** [`docs/specs/scene/weather-cloud-composition-plan.md`](docs/specs/scene/weather-cloud-composition-plan.md) — boundaries and Phase 10 prerequisites; queue **D** closed. **Default next** is Phase 10 lifecycle foundation—not live weather in render, and not reopening planning as a filler PR.
