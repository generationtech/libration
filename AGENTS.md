...
- **Dynamic data lifecycle (Phase 10):** [`docs/specs/scene/dynamic-data-lifecycle-plan.md`](docs/specs/scene/dynamic-data-lifecycle-plan.md) — step tracker `P10-*`; three snapshot kinds; in-app periodic acquisition; product-time binding. **Weather/cloud participation planning:** [`docs/specs/scene/weather-cloud-composition-plan.md`](docs/specs/scene/weather-cloud-composition-plan.md). **Default next** = first pending `P10-*` step—not live weather UI, not Phase 8/9 filler.
