...
- perceptually tuned lunar secondary illumination: moon phase, lunar altitude, and surface incidence contribute a bounded directional night-side secondary transmittance lift inside the same upstream planetary illumination raster, preserving base-substrate detail without backend moonlight semantics or additional render-layer kind.
