...
**Phase closure:** v1 + v1.1 are **production-complete**; the shell supplies emissive policy and substrate presentation inputs to `computeOverlayReadabilityFrameFromTimeMs` each tick (`App.tsx` → `TimeContext.overlayReadabilityFrame`).
