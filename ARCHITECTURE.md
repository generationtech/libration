...
- cloud and weather **implementation** / other dynamic overlays (`DLC-*`, next **`DLC-3`**; lifecycle plan + [`docs/specs/scene/weather-cloud-composition-plan.md`](docs/specs/scene/weather-cloud-composition-plan.md)).
