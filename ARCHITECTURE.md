...
- per-texel sampling of emissive radiance into the illumination raster and end-to-end visible night-lights composition (catalog and resolver exist; sampling wiring is Phase 3).
