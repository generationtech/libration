...
- **extended** composition-aware overlay readability: optional user-facing / SceneConfig readability controls; richer substrate modeling (e.g. per-family heuristics beyond presentation + catalog flags, still without backend policy).
