...
- **extended** composition-aware overlay readability: per-layer tuning, richer substrate modeling (e.g. per-family heuristics beyond presentation + catalog flags, still without backend policy).
