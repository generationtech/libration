...
- categorized map selector with **Source & license** attribution block (`BaseMapStyleControl`; catalog `attribution`, optional `licenseNote`, `sourceLinks`) and per-family base-map presentation UI.
