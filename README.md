...
Three **live data feeds** can be enabled — cloud and infrared imagery, earthquakes, and the ISS ground track. Clouds and earthquakes keep an offline fixture fallback. ISS hides when no live TLE can be acquired. None of them touch the render path.
