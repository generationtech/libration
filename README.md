...
- Upstream twilight field refined for smoother anchor coupling, cooler terminator tint progression, and a gentler day-side atmospheric envelope (still one `rasterPatch`; non-emissive modulation only).
