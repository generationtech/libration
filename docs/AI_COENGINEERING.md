...
- prefer **incremental** features (e.g. **`perLayer` pilots for new stack rows** beyond the six shipped defaults; richer catalog/resolver substrate heuristics beyond presentation + `capabilities`) over reopening settled composition architecture.
