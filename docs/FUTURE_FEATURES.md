...
**Lifecycle foundation:** Phase 10 (`P10-*` steps) in [`docs/specs/scene/dynamic-data-lifecycle-plan.md`](specs/scene/dynamic-data-lifecycle-plan.md)—in progress (**`P10-1`**/`P10-2`/`P10-3`/`P10-4` types/store/manager/resolver shipped; next **`P10-5`**); **no** user-facing dynamic overlay until post–Phase 10 **`DLC-*`**. Weather participation models: [`docs/specs/scene/weather-cloud-composition-plan.md`](specs/scene/weather-cloud-composition-plan.md).
