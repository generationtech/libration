...
- earthquake clustering, depth presentation, magnitude color bands, age fading, selection/detail, tsunami/alert symbology, historical FDSN, or Event Playback
