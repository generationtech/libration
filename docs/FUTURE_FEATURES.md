...
- Clouds overlap feathering in dual-coverage **q>0** interiors (not at coverage/no-data limbs, not at q=0 GEO skirts). [LIB-073](work/LIB-073-weather-5-2-ring-outranks-q0-regional-authority.md) removed the India / southern-ocean / Antarctic q=0 footprint class by preferring the ring over q=0 regionals. Remaining NATL East/MSG and Pacific West/Himawari handoffs are usable-quality crossovers; do not start a blend LIB automatically.
