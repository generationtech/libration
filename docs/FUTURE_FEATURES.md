...
- Clouds overlap feathering in dual-coverage interiors (not at coverage/no-data limbs)
- Clouds radiometric normalization / per-source IR curve matching
...
- IR highlight wash redesign (smoothstep 100→195 is a separate presentation problem; WEATHER-5)
