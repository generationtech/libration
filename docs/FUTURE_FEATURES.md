...
- Clouds overlap feathering in dual-coverage interiors (not at coverage/no-data limbs) — after [LIB-071](work/LIB-071-weather-5-1-canonical-ir-cloud-confidence.md) a live East/MSG pair kept identical winners while interior |Δα| dropped ~62 → 21. Residual geometric handoff can remain. WEATHER-5.2 stays unapproved; do not start it automatically.
