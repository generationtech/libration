...
- GEO limb-saturation filtering (selected-source MSG western rim may remain after coverage-authority repair)
- viewing-angle / nadir quality weighting among overlapping GEO disks
- IR highlight wash redesign (smoothstep 100→195 is a separate presentation problem)
