...
- emissive night-lights composition (upstream policy, scene config, bundled emissive composition catalog, and resolver are in place; illumination raster sampling remains to be wired).
