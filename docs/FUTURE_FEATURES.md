...
- overlay readability **beyond derived v1.1 + substrate lift scale + SceneConfig presentation scalars:** per-layer tuning where justified; richer catalog or resolver heuristics.
