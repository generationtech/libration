...
`SCENE_STACK_LAYER_IDS` in `src/config/v2/sceneConfig.ts` defines the fifteen known overlay ids, in canonical order:

```
solarShading, grid, staticEquirectOverlay, globalCloudsIr, solarEclipse, lunarEclipse,
