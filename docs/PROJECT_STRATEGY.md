...
2. Map inventory curation and selector polish (**default macro PR track:** Phase 8 / Slice 3; **single best next PR:** richer **attribution presentation** in map selector per `PLAN.md` queue **A** item **(1)**; all bundled family `previewThumbnailSrc` **shipped** including legacy reference).
