...
2. **Dynamic data lifecycle** (**default macro PR track:** Phase 10 / Slice 5, steps in [`docs/specs/scene/dynamic-data-lifecycle-plan.md`](specs/scene/dynamic-data-lifecycle-plan.md); next **`P10-3`**; **`P10-1`**/`P10-2` shipped). Lifecycle only in Phase 10; **`DLC-*`** consumers afterward (first: global equirect clouds/IR). Weather participation models: [`docs/specs/scene/weather-cloud-composition-plan.md`](specs/scene/weather-cloud-composition-plan.md).
