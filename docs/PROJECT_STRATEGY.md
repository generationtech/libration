...
2. Map inventory curation and selector polish (**default next PR:** legacy bundled preview, then attribution/selector polish or next sourced substrate per `PLAN.md` queue **A**; static trio previews **shipped**).
