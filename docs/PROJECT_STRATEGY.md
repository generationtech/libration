...
2. Map inventory curation and selector polish (**default macro PR track:** Phase 8 / Slice 3; **structured attribution presentation** in map selector **shipped**; **single best next PR:** next **A**-class substrate when sourced, else **Slice 4** month-aware selector polish per `PLAN.md` queue **A** items **(2)** / **(2b)**).
