...
The next strategic need is not another large hidden architecture migration. The **planetary composition baseline** (eight-intrinsic substrate lift, third twilight pass, overlay readability closure) is **complete** for standing incremental work—**Slice 2 queues B/C are closed** as default PR tracks. Default engineering pull is **Phase 10 / Slice 5** (dynamic data lifecycle). **Remaining Phase 8** map inventory and **Phase 9** composition extensions are **deferred until after Phase 10**. Composition extensions (**perLayer** beyond six defaults, ninth+ intrinsics, fourth+ twilight, deeper scattering) and cloud/weather **implementation** (after Phase 10 lifecycle) reopen only with **explicit product scope** or post–Phase 10 sequencing—not agent-invented filler PRs.
...
2. **Dynamic data lifecycle** (**default macro PR track:** Phase 10 / Slice 5). Weather/cloud **implementation** follows lifecycle foundations per [`docs/specs/scene/weather-cloud-composition-plan.md`](specs/scene/weather-cloud-composition-plan.md) (**planning closed**).
