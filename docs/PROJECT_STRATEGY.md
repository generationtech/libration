...
2. Map inventory curation and selector polish (**default next PR:** attribution/selector polish or next sourced substrate per `PLAN.md` queue **A**; all bundled family previews **shipped**).
