...
Moon visual development through [LIB-011](work/LIB-011-observer-oriented-lunar-libration.md) is complete. Eclipse architecture ([LIB-012](work/LIB-012-eclipse-system-architecture.md)), authority selection ([LIB-013](work/LIB-013-eclipse-authority-evaluation.md)), E1 live solar footprint ([LIB-014](work/LIB-014-solar-eclipse-live-footprint.md)), E2 solar forecast window ([LIB-015](work/LIB-015-solar-eclipse-forecast.md)), E3 lunar eclipse truth/visibility ([LIB-016](work/LIB-016-lunar-eclipse-truth-and-visibility.md)), E4 reference-city eclipse circumstances ([LIB-017](work/LIB-017-reference-city-eclipse-circumstances.md)), and E5 live alignment / beam ([LIB-018](work/LIB-018-eclipse-alignment-beam.md)) are complete. No LIB work is active or approved.

The strongest candidate for the **next** product-development effort is **E6 — configuration completeness and integration polish**. Intended structure: [`docs/specs/scene/eclipse-system.md`](specs/scene/eclipse-system.md). Product intent: [`docs/FUTURE_FEATURES.md`](FUTURE_FEATURES.md#eclipse-system). E6+ implementation is **not** approved. Other lunar and Sun–Moon–Earth ideas in that family remain unapproved backlog.
...
Time-relative geographic overlays remain a strategic theme. The lunar-locus experiment and production overlay are complete ([LIB-006](work/LIB-006-experimental-lunar-locus.md), [LIB-007](work/LIB-007-lunar-locus.md)). E1 solar eclipse live footprint, E2 forecast corridor, E3 lunar eclipse truth/visibility, and E5 live alignment / beam are production ([LIB-014](work/LIB-014-solar-eclipse-live-footprint.md), [LIB-015](work/LIB-015-solar-eclipse-forecast.md), [LIB-016](work/LIB-016-lunar-eclipse-truth-and-visibility.md), [LIB-018](work/LIB-018-eclipse-alignment-beam.md)). Remaining ideas in this theme stay unapproved in [`docs/FUTURE_FEATURES.md`](FUTURE_FEATURES.md). Where a new overlay can be derived from existing solar and lunar models, prefer that over a second ephemeris. Eclipse event truth uses the bundled NASA/Espenak–Meeus authority, not the visualization-grade Sun/Moon models; see [`docs/specs/scene/eclipse-system.md`](specs/scene/eclipse-system.md) and [ADR 0008](decisions/0008-bundled-nasa-solar-eclipse-authority.md). The preferred next slice of this theme is E6 (configuration completeness), recorded above.
