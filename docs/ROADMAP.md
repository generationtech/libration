...
Moon visual development through [LIB-011](work/LIB-011-observer-oriented-lunar-libration.md) is complete. Eclipse architecture ([LIB-012](work/LIB-012-eclipse-system-architecture.md)), authority selection ([LIB-013](work/LIB-013-eclipse-authority-evaluation.md)), E1 live solar footprint ([LIB-014](work/LIB-014-solar-eclipse-live-footprint.md)), E2 solar forecast window ([LIB-015](work/LIB-015-solar-eclipse-forecast.md)), and E3 lunar eclipse truth/visibility ([LIB-016](work/LIB-016-lunar-eclipse-truth-and-visibility.md)) are complete. No LIB work is active or approved.

The strongest candidate for the **next** product-development effort is **E4 — reference-city eclipse circumstances**. Intended structure: [`docs/specs/scene/eclipse-system.md`](specs/scene/eclipse-system.md). Product intent: [`docs/FUTURE_FEATURES.md`](FUTURE_FEATURES.md#eclipse-system). E4+ implementation is **not** approved. Other lunar and Sun–Moon–Earth ideas in that family remain unapproved backlog.
