...
| `moon-libration` | `2021-12-10T00:00:00.000Z` (default `librationEpoch=diagonal`) | Production Moon glyph with optical-libration **ring** on. Optional DEV `librationEpoch=zero\|lonEast\|lonWest\|latNorth\|latSouth\|diagonal\|new\|quarter\|full` | Phase vs libration independence; ring/crosshair; Moon sizes; indicator stays inside the disc; accelerated demo motion; pause freeze |
