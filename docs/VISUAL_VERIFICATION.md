...
11. India / southern Indian Ocean / Antarctic q=0 footprints: large Meteosat WMS circular cuts and GEO-limb wedges must not dominate where ring coverage exists. Remaining ring-native scallops are provider-intrinsic and may remain. True polar no-data stays transparent.
