...
| `lunar-locus` | `2026-01-16T22:00:00.000Z` (default `locusEpoch=recent`) | Development-only lunar-day residual locus: Moon marker on, ground track off, analemma off. Optional `locusEpoch=standstill\|minor\|baseline`, `locusMode=geographic\|residual\|glyph`, `locusTreatment=dots\|dots-line` | Compact lunar locus vs solar analemma and vs the 48 h ground-track weave |
