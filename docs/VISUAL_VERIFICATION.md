...
10. Quality-aware North Atlantic handoff: the conspicuous Meteosat western disk-edge arc must not be the cloud source transition where GOES-East has substantially better viewing geometry. GOES-East should own the western North Atlantic; Meteosat should take authority farther east where its view becomes competitive. A residual contrast/cloud-wash step near that geometric handoff may remain (radiometric mismatch; not an authority failure). Cyclone structures must not look basin-wide blended.
