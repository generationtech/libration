...
| `solar-eclipse-total` | `2024-04-08T18:17:15.000Z` | Production solar eclipse overlay at NASA 2024 Apr 08 greatest eclipse (total). Solar eclipses on; live feeds off; Sun/Moon glyphs on | Path across Mexico / US / Canada; umbral band vs broader partial region; overlay vs solar shading; glyph coherence |
...
| `solar-eclipse-dateline` | `2016-03-09T01:57:09.400Z` | Production solar eclipse overlay at NASA 2016 Mar 09 Pacific total | Seam/wrap: no map-spanning fill, coherent centerline and band |
