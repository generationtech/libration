...
2. **Scene reference frame** is a transform of that state into the coordinates that projection consumes. Earth-fixed is identity, is the default, and remains a production frame ([LIB-082](../work/LIB-082-scene-reference-frame-foundation.md)). Production frames are Earth-fixed or anchored ([LIB-086](../work/LIB-086-generalize-anchored-scene-reference-frames.md), [ADR 0030](0030-anchored-scene-frames-are-one-production-kind.md)). Moon longitude-lock ([LIB-083](../work/LIB-083-moon-longitude-locked-scene-frame.md), [ADR 0027](0027-moon-longitude-lock-is-a-scene-reference-frame.md)), Moon position-lock ([LIB-084](../work/LIB-084-moon-position-locked-scene-frame.md), [ADR 0028](0028-moon-position-lock-translates-scene-frame-latitude.md)), and Sun longitude-lock / position-lock ([LIB-085](../work/LIB-085-sun-anchored-scene-frames.md), [ADR 0029](0029-sun-anchoring-reuses-moon-axis-lock.md)) are `anchorKind` + `lockMode` configurations of that model. Entity-fixed must not be implemented by overwriting camera centre each frame.
