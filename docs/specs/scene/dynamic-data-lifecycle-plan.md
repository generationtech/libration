...
| 1 | `P10-1` | pending | **Core types & contracts** — TypeScript types for snapshot kinds, temporal metadata, source ids, freshness enum; pure helpers + unit tests. No network, no UI. |
