...
5. No solar-style terrestrial corridor. Lunar map geography (LIB-044) reuses this same Moon-visible construction at the **current product instant** for upcoming and active events; GE visibility remains placard/event-information context, not a frozen map preview.
