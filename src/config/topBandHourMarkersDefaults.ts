...
/**
 * Neutral defaults for top-band hour marker appearance (resolver + glyph emission).
...
export const DEFAULT_ANALOG_FACE_FILL = "rgba(235, 246, 255, 0.97)";

export const DEFAULT_RADIAL_LINE_COLOR = "rgba(8, 28, 58, 0.94)";
export const DEFAULT_RADIAL_WEDGE_FILL = "rgba(8, 28, 58, 0.32)";
