...
export interface TopChromeTickTokens {
  ...
  /**
   * Core stroke for the active structural meridian on the tickmarks tape (distinct from generic hour ticks).
   */
...
export type TopChromeStyle = typeof TOP_CHROME_STYLE_IMPL;

/**
 * Built-in top-strip styling (single fixed appearance; former “neutral” instrument field).
 */
export const TOP_CHROME_STYLE = TOP_CHROME_STYLE_IMPL;
