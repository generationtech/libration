...
import type { GeographyConfig, TopBandAnchorConfig } from "../config/appConfig.ts";
import { REFERENCE_CITIES } from "../data/referenceCities.ts";
import { utcOffsetHoursForTimeZone } from "./timeZoneOffset.ts";
...
/**
 * Resolves the meridian used to place the top tape **read point** on the equirectangular strip (longitude only).
 *
